...
if !has("gui_running")
    ...
    hi StatusLine       cterm=NONE      ctermfg=187     ctermbg=80
    hi StatusLineNC     cterm=NONE      ctermfg=58      ctermbg=100
    hi User1            cterm=NONE      ctermfg=28      ctermbg=NONE
    hi User2            cterm=NONE      ctermfg=39      ctermbg=NONE
    hi VertSplit        cterm=NONE      ctermfg=144     ctermbg=80
    hi WildMenu         cterm=BOLD      ctermfg=187     ctermbg=50
    ...
    hi LineNr           cterm=NONE      ctermfg=58      ctermbg=80
    hi NonText          cterm=NONE      ctermfg=58      ctermbg=80
    ...
    hi Statement        cterm=BOLD      ctermfg=89      ctermbg=NONE
...
if has("gui_running")
    ...
    hi WildMenu         gui=BOLD        guifg=#5f5f00   guibg=#afaf87
    ...
    hi Statement        gui=BOLD        guifg=#87005f   guibg=NONE
...
if !has("gui_running") && v:version >= 700
    ...
    hi TabLineSel       cterm=BOLD      ctermfg=187     ctermbg=50
